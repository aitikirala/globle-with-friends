...
const firebaseConfig = {
  ...
  measurementId: process.env.REACT_APP_FIREBASE_MEASUREMENT_ID, // This is optional if you're not using analytics
};

// Initialize Firebase
const app = initializeApp(firebaseConfig);
export const db = getFirestore(app); // Initialize and export Firestore
export const auth = getAuth(app); // Initialize and export Firebase Authentication (if used)
